...
api_url = "https://new-cpapi-temp-489b660e8679.herokuapp.com/ITsBoss?url="
    ...
    try:
        for i in range(arg-1, len(links)):
            ...
            if "acecwply" in url:
                ...
                url = f"https://new-cpapi-temp-489b660e8679.herokuapp.com/ITsBoss/extract_keys?url={url}"
                mpd, keys = helper.get_mps_and_keys(url)
                url = mpd
                keys_string = " ".join([f"--key {key}" for key in keys])

            elif "classplusapp" in url:
                signed_api = f"https://new-cpapi-temp-489b660e8679.herokuapp.com/ITsBoss/extract_keys?url={url}"
